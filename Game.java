...
import Nuclear.GameWindow.GameWindow;
import Nuclear.Graphics.Assets;
import Nuclear.Input.KeyManager;
import Nuclear.States.*;
...
/**
 * The Game class is a singleton, allowing one single instance of itself at any given moment
 */
...
public class Game implements Runnable {
    ...
    private void InitGame() {
        ...
        currentState = new MenuState(refLink);
        keyManager.LoadSettings();
    }
    ...
    public synchronized void StopGame() {
        if (runState == true) {
            ...
            try {
                wnd.GetWndFrame().dispatchEvent(new WindowEvent(wnd.GetWndFrame(), WindowEvent.WINDOW_CLOSING));
    ...
    public Graphics GetGraphics() {
        return wnd.GetCanvas().getBufferStrategy().getDrawGraphics();
    }
